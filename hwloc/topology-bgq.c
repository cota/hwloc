...
static int
hwloc_bgq__get_disallowed_resources(struct hwloc_topology *topology)
{
  const char *env;
  unsigned i;
...
hwloc_look_bgq(struct hwloc_backend *backend)
{
  ...
  hwloc_bgq__get_disallowed_resources(topology);
...
static int
hwloc_bgq_get_disallowed_resources(struct hwloc_topology *topology)
{
   ...
   */
  return hwloc_bgq__get_disallowed_resources(topology);
}
		    ...
		    struct hwloc_topology_support *support __hwloc_attribute_unused)
{
  ...
  hooks->get_disallowed_resources = hwloc_bgq_get_disallowed_resources;
}
